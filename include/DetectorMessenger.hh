...
{
 public:
  DetectorMessenger(MyDetectorConstruction*);
 ...
 private:
  ...
  G4UIcmdWithADoubleAndUnit* fMaterialDensity = nullptr;
  
  G4UIcmdWithADoubleAndUnit* fMaterialThickness = nullptr;
